...
function_verify () {
  ...
  echo -e "\n\n\n\n\033[1;32m====================================\n\033[1;31mNO HAY VERSIÓN OFICIAL, POR FAVOR VUELVA A INSTALAR\n====================================\033[0m\n"
...
valid_fun () {
echo -e "${cor[2]}$(source trans -b pt:${id} "¡Ea!, Clave Valida! Comenzando instalacion...")"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
[[ -d /etc/adm-lite ]] && rm -rf /etc/adm-lite
mkdir /etc/adm-lite
cd /etc/adm-lite
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[3]}$(source trans -b pt:${id} "Perfecto Procedimiento terminado con Éxito!")"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[3]} |∆| ${cor[2]}$(source trans -b pt:${id} "Ahora sólo tienes que configurar tu VPS con el menú de instalación")"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]}$(source trans -b pt:${id} "Usa unos de los dos comandos"): menu, adm"
echo -e "${cor[2]}$(source trans -b pt:${id} "para acceder al menu. Gracias por usar ADM IFS PLUS!")"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne " \033[0m"
}
...
unset serial
unset server
echo -ne "\033[1;33m$(source trans -b pt:${id} "Ahora escriba su llave!"): \033[1;37m"; read serial
...
rm $HOME/tmp
    ...
    echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠\033[0m"
    echo -ne "${cor[2]}$(source trans -b pt:${id} "Tienes otra llave?") [S/N]: "; read other
...
error_fun () {
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "\033[1;31mTienes un error de apt-get!"
echo -e "Reinicia el sistema!"
echo -e "Usar el comando:"
echo -e "\033[1;36mdpkg --configure -a"
echo -e "\033[1;31mVerifica tu Source.list"
echo -e "Para actualizar la lista de fuentes use este comando:"
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]}Selecciona tu idioma\n${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠\n${cor[2]}[1]-PT-BR\n[2]-EN\n[3]-ES\n[4]-FR"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} $(source trans -b pt:${id} "Utilice el enlace de instalación oficial"):\n\033[1;36m (https://www.dropbox.com/s/h9akd45o4i1fyuk/instala.sh)${cor[2]}\n $(source trans -b pt:${id} "No utilize otros links!")"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[5]} $(source trans -b pt:${id} "Instalador de ADM IFS PLUS") ®"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
